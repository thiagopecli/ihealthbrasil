...
SHIPPING_ORIGIN_CEP = os.getenv("SHIPPING_ORIGIN_CEP", "00000000")
SHIPPING_DEFAULT_ITEM_WEIGHT_KG = os.getenv("SHIPPING_DEFAULT_ITEM_WEIGHT_KG", "0.50")
SHIPPING_DEFAULT_PACKAGE_LENGTH_CM = os.getenv("SHIPPING_DEFAULT_PACKAGE_LENGTH_CM", "20")
SHIPPING_DEFAULT_PACKAGE_HEIGHT_CM = os.getenv("SHIPPING_DEFAULT_PACKAGE_HEIGHT_CM", "10")
SHIPPING_DEFAULT_PACKAGE_WIDTH_CM = os.getenv("SHIPPING_DEFAULT_PACKAGE_WIDTH_CM", "15")
CORREIOS_API_BASE_URL = os.getenv(
    "CORREIOS_API_BASE_URL",
    "https://ws.correios.com.br/calculador/CalcPrecoPrazo.aspx",
)
CORREIOS_ACCOUNT_CODE = os.getenv("CORREIOS_ACCOUNT_CODE", "")
CORREIOS_ACCOUNT_PASSWORD = os.getenv("CORREIOS_ACCOUNT_PASSWORD", "")
CORREIOS_SERVICE_CODES = os.getenv("CORREIOS_SERVICE_CODES", "04014,04510")
CORREIOS_PACKAGE_FORMAT = os.getenv("CORREIOS_PACKAGE_FORMAT", "1")
CORREIOS_CALCULATION_MODE = os.getenv("CORREIOS_CALCULATION_MODE", "3")
